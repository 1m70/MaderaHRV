 ...
 */
final class Version20191007202311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD plan_id INT DEFAULT NULL, CHANGE payment_id payment_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EEE899029B FOREIGN KEY (plan_id) REFERENCES plan (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2FB3D0EEE899029B ON project (plan_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_2FB3D0EEE899029B ON project');
        $this->addSql('ALTER TABLE project DROP plan_id, CHANGE user_id user_id INT DEFAULT NULL, CHANGE payment_id payment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE quotation CHANGE date_end date_end DATETIME DEFAULT \'NULL\', CHANGE prix_ht prix_ht DOUBLE PRECISION DEFAULT \'NULL\', CHANGE prix_ttc prix_ttc DOUBLE PRECISION DEFAULT \'NULL\'');
